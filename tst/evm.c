...
void test_sdiv() {
    ...
    op_t program[] = {
        PUSH1, 4, PUSH1, 9, SDIV, MSIZE, MSTORE,
        PUSH32,
    ...
    assert(result.returnData.size == sizeof(expected));
    for (size_t i = 0; i < result.returnData.size; i+=32) {
        if (memcmp(result.returnData.content+i, expected+i, 32)) {
            fprintf(stderr, "%zu:\n< ", i);
            for (size_t j = i; j < i + 32; j++) {
                fprintf(stderr, "%02x", result.returnData.content[j]);
            }
            fputs("\n> ", stderr);
            for (size_t j = i; j < i + 32; j++) {
...
void test_smod() {
    ...
    op_t program[] = {
        PUSH1, 4, PUSH1, 9, SMOD, MSIZE, MSTORE,
        PUSH32,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc,
        PUSH1, 9, SMOD, MSIZE, MSTORE,
        PUSH1, 4,
        PUSH32,
        0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xf7,
        SMOD, MSIZE, MSTORE,
        ...
        0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        PUSH32,
        0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
        SMOD, MSIZE, MSTORE,
        PUSH32,
        0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        PUSH32,
...
void test_addmod() {
    ...
    op_t program[] = {
        ...
        DUP3, DUP3, DUP3, ADDMOD, MSIZE, MSTORE,
        DUP4, DUP4, DUP3, ADDMOD, MSIZE, MSTORE,
        DUP2, DUP4, DUP3, ADDMOD, MSIZE, MSTORE,
        DUP4, DUP4, DUP4, ADDMOD, MSIZE, MSTORE,
        DUP5, DUP5, DUP5, ADDMOD, MSIZE, MSTORE,
        DUP3, DUP5, DUP6, ADDMOD, MSIZE, MSTORE,
        DUP3, DUP5, DUP5, ADDMOD, MSIZE, MSTORE,
        MSIZE, PUSH0, RETURN
    };
    input.content = program;
    input.size = sizeof(program);
    ...
    op_t expected[] = {
        ...
        0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6, 0xe6,
        0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73, 0x73,
    };
    result_t result = txCreate(from, gas, value, input);
    assert(result.gasRemaining == 0);
...
void test_mulmod() {
    ...
    op_t program[] = {
        ...
        PUSH32,
        0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11, 0x11,
        DUP3, DUP3, DUP3, MULMOD, MSIZE, MSTORE,
        DUP4, DUP4, DUP3, MULMOD, MSIZE, MSTORE,
        DUP2, DUP4, DUP3, MULMOD, MSIZE, MSTORE,
        DUP4, DUP4, DUP4, MULMOD, MSIZE, MSTORE,
        DUP5, DUP5, DUP5, MULMOD, MSIZE, MSTORE,
        DUP3, DUP5, DUP6, MULMOD, MSIZE, MSTORE,
        DUP3, DUP5, DUP5, MULMOD, MSIZE, MSTORE,
        MSIZE, PUSH0, RETURN
    };
    input.content = program;
    input.size = sizeof(program);
...
void test_signextend() {
    ...
    op_t program[] = {
        PUSH32,
        0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f, 0x7f, 0x8f,
        PUSH0,
        JUMPDEST,
        DUP2, DUP2, SIGNEXTEND, MSIZE, MSTORE,
        PUSH1, 1, ADD,
        PUSH1, 33, DUP2, LT, PUSH1, 34, JUMPI,
        MSIZE, PUSH0, RETURN
    };
    ...
    op_t expected[] = {
        ...
        
    };
    assert(result.returnData.size == sizeof(expected));
    if (memcmp(result.returnData.content, expected, sizeof(expected))) {
...
#define CREATE_REVERT \
    ...
    // fprintf(stderr, "\nGas Remaining %llu\n", result.gasRemaining);
    assert(result.gasRemaining == 16691217);
    ...
    assert(memcmp(result.returnData.content, revertOut, sizeof(revertOut)) == 0);
...
void test_createInsufficientBalance() {
    ...
    assert(memcmp(result.returnData.content, failOut, sizeof(failOut)) == 0);

    // fprintf(stderr, "\nGas Remaining %llu\n", result.gasRemaining);
    assert(result.gasRemaining == 16691424);
